...
// Confirm modal (defaults to a red "Delete" button; callers can customize)
let _confirmResolve = null;
function confirmDelete(msg, confirmLabel = 'Delete', confirmClass = 'btn btn-danger') {
  return new Promise(resolve => {
    _confirmResolve = resolve;
    $('confirm-modal-msg').textContent = msg;
    const yes = $('btn-confirm-yes');
    yes.textContent = confirmLabel;
    yes.className = confirmClass;
    show($('confirm-modal'));
  });
}
